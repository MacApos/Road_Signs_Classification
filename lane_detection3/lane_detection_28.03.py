...
t_righty = poly[:, width//2:].nonzero()[1]+width//2
...
t_left_curve = np.polyfit(t_leftx, t_lefty, 2)
t_right_curve = np.polyfit(t_rightx, t_righty, 2)


down = min(min(t_leftx), min(t_rightx))
up = max(max(t_leftx), max(t_rightx))
difference = up-down

t_y = np.linspace(down, up, difference).astype(int)
t_left_x = t_left_curve[0] * t_y ** 2 + t_left_curve[1] * t_y + t_left_curve[2]
t_right_x = t_right_curve[0] * t_y ** 2 + t_right_curve[1] * t_y + t_right_curve[2]

for idx, y in enumerate(t_y):
    x_l = int(t_left_x[idx])
    x_r = int(t_right_x[idx])
    cv2.circle(poly, (x_l, y), radius=2, color=(0, 255, 255), thickness=-1)
    cv2.circle(poly, (x_r, y), radius=2, color=(0, 255, 255), thickness=-1)
...
val = 50
cv2.line(poly, (val, val), (2*val, val), color=(0, 0, 255), thickness=2)
cv2.line(poly, (val, val), (val, 2*val), color=(0, 255, 0), thickness=2)
cv2.putText(poly, 'cv', (val//10, val//2), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(poly, 'x', (2*val, val//2), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(poly, 'y', (val+val//2, 2*val), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

cv2.line(poly, (val, 4*val), (val, 5*val), color=(0, 0, 255), thickness=2)
cv2.line(poly, (val, 4*val), (2*val, 4*val), color=(0, 255, 0), thickness=2)
cv2.putText(poly, 'np', (val//10, 4*val-val//2), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(poly, 'y', (2*val, 4*val-val//2), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(poly, 'x', (val+val//2, 5*val), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
