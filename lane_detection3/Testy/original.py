    ...
    for fname in image_list:
        ...
        for window in range(nwindows):
            ...
            if left_tracker == True and right_tracker == True:
                good_left_inds, leftx_current = left_line_detect(out_img, leftx_current, margin, minpix, nonzerox,
                                                                 nonzeroy, win_y_low, win_y_high, window_max, counter)
                good_right_inds, rightx_current = right_line_detect(out_img, rightx_current, margin, minpix, nonzerox,
